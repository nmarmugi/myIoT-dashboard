...
<template>
    <tr :class="['odd:bg-white even:bg-gray-50 hover:bg-blue-50 transition-colors text-secondaryText', sensor.id === measurementsStore.measurements?.id && 'border-2 border-yellow-400']">
